...
export const Button = forwardRef<React.ElementRef<'button'>, ButtonProps>(function Button(
  { className, variant = 'default', icon, iconAlignment = 'left', circle, type = 'button', isDisabled, isLoading, children, ...rest },
  ref,
) {
  return (
    <button
