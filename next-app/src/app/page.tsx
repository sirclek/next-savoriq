...
export default function LandingPage() {
  return (
    <main>
      <Container maxWidth="xl" className="flex flex-col items-end justify-end p-1 lg:flex-row">
      ...
      <Container maxWidth="xl" className="flex flex-col items-center justify-center p-4 lg:flex-row">
        ...
        <div className="flex flex-col items-center gap-4 px-4 py-12 text-center md:order-2">
          <h1 className="text-m5xl font-black text-primary sm:text-7xl lg:text-8xl">{APP_TITLE}</h1>
          <Divider />
