    ...
    <div className="flex flex-col items-center justify-center text-center gap-8 min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto text-foreground">
        ...
        <div className="mb-8">
          ...
          <p>
            Dive into a world where science meets sensory experience and elevate your whisky journey with SavorIQ’s advanced search features and personalized recommendations. We aim to revolutionize how whisky is experienced, offering personalized insights for a more enriching journey.
          </p>
        </div>
      </div>
